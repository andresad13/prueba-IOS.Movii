...
class SearchRemoteDataManager:SearchRemoteDataManagerInputProtocol {
    ...
    func externalGetData(receivedData: String) {
        ...
        var request = URLRequest(url: URL(string: "https://api.spotify.com/v1/search?q=\(receivedData)&type=artist")!)
        ...
        if respuesta.statusCode == 200 {
            ...
            do{
                ...
                let getURL = try decoder.decode(ArtistURL.self, from: data)
                print(getURL)
